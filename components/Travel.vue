<template>
   <div class="min-h-screen relative overflow-hidden">
    ...
    <div class="relative text-center py-16 z-10">
      ...
      <h2 class="text-white text-5xl md:text-6xl" style="font-weight: 500;">สถานที่ท่องเที่ยว</h2>
    </div>
    ...
    <div v-else class="relative max-w-7xl mx-auto px-6 pb-20 z-10">
      ...
      <!-- No Data State -->
      <div v-if="travel.length === 0 && !loading" class="text-center text-white py-16">
