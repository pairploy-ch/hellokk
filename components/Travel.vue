<template>
  <div class="min-h-screen relative overflow-hidden">
    ...
    <div class="absolute inset-0 bg-black/40">
      <div
        class="absolute inset-0 bg-gradient-to-b from-gray-900/30 via-gray-800/20 to-gray-900/50"
      ></div>
      <div
        class="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-black/30 to-transparent"
      ></div>
    </div>

    <!-- Header -->
    <div class="relative text-center py-16 z-10">
      <h1 class="text-white text-xl font-light mb-2">Tourist</h1>
      <h2 class="text-white text-5xl md:text-6xl" style="font-weight: 500">
        สถานที่ท่องเที่ยว
      </h2>
    </div>
    ...
    <div v-else class="relative max-w-7xl mx-auto px-6 pb-20 z-10">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 h-[500px]">
        ...
        >
          ...
          <div class="p-5">
            <p class="text-gray-500 text-sm mb-2" style="font-weight: 400">
              {{ featuredAttraction.category }}
            </p>
            <h3
              class="text-base font-bold text-gray-800 mb-4 leading-tight"
              style="font-weight: 600"
            >
              {{ featuredAttraction.name }}
            </h3>
            <p
              v-if="featuredAttraction.content"
        ...
        <div class="md:col-span-2 grid grid-cols-2 gap-4">
          ...
          >
            ...
            <div class="p-3">
              <p class="text-gray-500 text-xs mb-1" style="font-weight: 400">
                {{ attraction.category }}
              </p>
              <h3
      ...
      <!-- No Data State -->
      <div
        v-if="travel.length === 0 && !loading"
        class="text-center text-white py-16"
      >
